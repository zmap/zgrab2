...
RUN_ARGS="-td --rm --name $CONTAINER_NAME -p 33007:7 -p 33009:9 -p 33013:13 -p 33019:19 -p 33037:37 -p 33007:7/udp -p 33009:9/udp -p 33013:13/udp -p 33019:19/udp -p 33037:37/udp"
