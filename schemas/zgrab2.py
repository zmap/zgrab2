...
tls_log = SubRecord({
    "handshake_log": zcrypto.tls_handshake.new(doc="The TLS handshake log."),
    "heartbleed_log": zcrypto.heartbleed_log.new(doc="The heartbleed scan log, if heartbleed scanning was enabled; otherwise, absent.")
})
