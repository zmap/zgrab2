...
func (connection *Connection) Handshake(ctx context.Context, target *zgrab2.ScanTarget, encryptModeStr string, tlsWrapper func(ctx context.Context, target *zgrab2.ScanTarget, l4Conn net.Conn) (*tlslog.TLSConnection, error)) (EncryptMode, error) {
