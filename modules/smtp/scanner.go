...
func (scanner *Scanner) Scan(ctx context.Context, dialGroup *zgrab2.DialerGroup, target *zgrab2.ScanTarget) (zgrab2.ScanStatus, any, error) {
	...
	// subsequent application-layer errors to map to SCAN_TLS_APPLICATION_ERROR
	// instead of SCAN_APPLICATION_ERROR.
	tlsActive := false
	appErrStatus := func() zgrab2.ScanStatus {
		if tlsActive {
			return zgrab2.SCAN_TLS_APPLICATION_ERROR
		}
	...
	if tlsActive && sr == zgrab2.SCAN_APPLICATION_ERROR {
		sr = zgrab2.SCAN_TLS_APPLICATION_ERROR
	}
	...
	if sr == zgrab2.SCAN_APPLICATION_ERROR || sr == zgrab2.SCAN_TLS_APPLICATION_ERROR {
