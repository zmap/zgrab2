...
func NewModule() *zgrab2.TypedModule[Flags, Scanner, *Scanner] {
	return zgrab2.NewTypedModule[Flags, Scanner, *Scanner]("bacnet", "Building Automation and Control Network (BACNET)", "Probe for devices that speak Bacnet, commonly used for HVAC control.", 0xBAC0)
}
