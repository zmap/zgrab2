...
func TestHandshakeComplete_failure(t *testing.T) {
	...
	log := tlsConn.GetLog()
	if log.HandshakeComplete {
		t.Error("HandshakeComplete should be false after a failed handshake")
	}
}

func TestHandshakeComplete_success(t *testing.T) {
	...
	log := tlsConn.GetLog()
	if !log.HandshakeComplete {
		t.Error("HandshakeComplete should be true after a successful handshake")
	}
}
