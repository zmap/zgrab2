...
type HTTPFlags struct {
	Credentials map[string]string `long:"creds" description:"Specify a hostname and credentials for authenticating to it. Provide in the form \"hostname\":\"username:password\". Multiple can be specified. Overrides credentials specified using --creds-file"`
