...
To add a schema for the new module, add a module under schemas, and update [`schemas/__init__.py`](zgrab2_schemas/__init__.py) to ensure that it is loaded.

See [schemas/README.md](zgrab2_schemas/README.md) for details.
