...
To add a schema for the new module, add a module under schemas, and update [`zgrab2_schemas/__init__.py`](zgrab2_schemas/__init__.py) to ensure that it is loaded.
